      ...
      <div className="container">
        ...
        <div className={styles.body}>
          <section className={styles.block}>
            <h2 className={styles.blockTitle}>{study.contextLabel}</h2>
          ...
          <section className={styles.block}>
            ...
            <dl className={styles.built}>
              {study.built.map((item) => (
                <div key={item.title} className={styles.builtItem}>
                  <dt className={styles.builtTitle}>{item.title}</dt>
                  <dd className={styles.builtDetail}>{item.detail}</dd>
                </div>
              ))}
            </dl>
          </section>
