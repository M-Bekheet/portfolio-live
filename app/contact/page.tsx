...
const Contact = () => {
  ...
  // <SEO
  //   title="Contact"
  //   description="Contact Mahmoud Bekheet, an experienced Full-stack Developer proficient in React, TypeScript, and Node.js. Bringing a strong skill set in both front-end and back-end development."
